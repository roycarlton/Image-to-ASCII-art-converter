...
The program requires a .ttf font file because the character for each pixel is decided by comparing the pixel to small images of each ASCII character generated from that font to see whihc is most similar.
